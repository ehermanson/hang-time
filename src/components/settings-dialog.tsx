...
import { Ruler, Settings, Sun, Moon } from 'lucide-react'
...
const themeOptions: { value: Theme; label: string; desc: string; icon: typeof Sun }[] = [
  { value: 'light', label: 'Light', desc: 'Bright and clean interface', icon: Sun },
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              ...
              <Label className="text-sm font-medium dark:text-white/80">Appearance</Label>
            </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              ...
              <Label className="text-sm font-medium dark:text-white/80">Measurement Units</Label>
            </div>
