...
function HangingTypePreview({
  ...
  const frameColor = isSelected
    ...
    : 'stroke-gray-400 dark:stroke-white/40';
  const frameFill = isSelected
    ? 'fill-pink-50 dark:fill-pink-500/20'
    : 'fill-gray-50 dark:fill-white/10';
  const hookColor = isSelected
    ? 'fill-pink-500 dark:fill-pink-400'
    : 'fill-gray-400 dark:fill-white/50';
