...
import { Images, Magnet, Move, Sofa, ChevronDown } from 'lucide-react'
  ...
  return (
    <div className="space-y-4">
          ...
          <div className="space-y-3 pt-3">
            <div className="flex items-center gap-3">
              <div className="flex-1 space-y-1.5">
                <Label>Snap Gap ({state.unit})</Label>
                <Input
                  type="number"
                  step="0.125"
              ...
              <div className="flex-1">
                <Label className="block mb-1.5">Snapping</Label>
                <label className="flex items-center gap-2 cursor-pointer">
                  ...
                  />
                  <span className="text-sm text-gray-700 dark:text-white/70">Enable</span>
                </label>
              </div>
            </div>
            <div className="flex gap-2">
              <Button variant="outline" size="sm" className="flex-1 text-xs" onClick={selectAllFrames}>
                <Move className="h-3 w-3 mr-1" /> Select All
              </Button>
              <Button variant="outline" size="sm" className="flex-1 text-xs" onClick={clearFrameSelection}>
                Clear Selection
              </Button>
            </div>
        ...
        <CollapsibleContent>
          <div className="space-y-3 pt-3">
            <div className="grid grid-cols-3 gap-2">
              ...
              <div className="space-y-1.5">
                <Label>X Offset ({state.unit})</Label>
                <Input
                  type="number"
                  step="0.125"
      ...
      <Collapsible defaultOpen>
        ...
        <CollapsibleContent>
          <div className="max-h-[200px] overflow-y-auto space-y-2 pt-3">
          {state.galleryFrames.map((frame) => {
            ...
            <div
              ...
              className={cn(
                ...
                isPrimary ? "border-indigo-500 bg-indigo-50 dark:bg-indigo-500/20" :
                isSelected ? "border-indigo-400 bg-indigo-50/50 dark:border-indigo-400/50 dark:bg-indigo-500/10" : "border-gray-200 bg-gray-50 dark:border-white/10 dark:bg-white/5"
              )}
